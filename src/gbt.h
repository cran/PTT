...
public:
    ...
    // Reusable scratch space avoids a heap allocation at every tree node
    // while retaining standard C++ portability (unlike variable-length
    // stack arrays).
    vector<double> work_Z;
    vector<double> work_phi;
    vector<double> work_gam;
    vector<double> work_unnormalized_rho;
