...
RcppExport SEXP _PTT_fitPTTcpp(SEXP XSEXP, SEXP XnewSEXP, SEXP OmegaSEXP, SEXP kSEXP, SEXP rho0SEXP, SEXP rho0_modeSEXP, SEXP tran_modeSEXP, SEXP lognu_lowerboundSEXP, SEXP lognu_upperboundSEXP, SEXP n_gridSEXP, SEXP n_sSEXP, SEXP betaSEXP, SEXP n_post_samplesSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _PTT_fitCondPTTcpp(SEXP XSEXP, SEXP YSEXP, SEXP XnewSEXP, SEXP YnewSEXP, SEXP Omega_XSEXP, SEXP Omega_YSEXP, SEXP k_XSEXP, SEXP k_YSEXP, SEXP rho0_XSEXP, SEXP rho0_mode_XSEXP, SEXP rho0_YSEXP, SEXP rho0_mode_YSEXP, SEXP tran_mode_YSEXP, SEXP lognu_lowerbound_YSEXP, SEXP lognu_upperbound_YSEXP, SEXP n_grid_YSEXP, SEXP n_s_YSEXP, SEXP beta_YSEXP, SEXP n_post_samplesSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type X(XSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_PTT_fitPTTcpp", (DL_FUNC) &_PTT_fitPTTcpp, 13},
    {"_PTT_fitCondPTTcpp", (DL_FUNC) &_PTT_fitCondPTTcpp, 19},
    {NULL, NULL, 0}
};

RcppExport void R_init_PTT(DllInfo *dll) {
